...
/**
 */
public class FragmentCAdapter<T> extends BaseAdapter {
    List<T> data = new ArrayList<T>();
    private LayoutInflater mInflater;
    private Context mContext;

    public FragmentCAdapter() {
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final GroupResponse response = (GroupResponse) getItem(position);
        holder.mNotice.setText(response.getName());
        Log.d("ssssssssss","3");
        return convertView;
    }
