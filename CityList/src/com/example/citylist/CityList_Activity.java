...
import com.example.citylist.MyLetterListView.OnTouchingLetterChangedListener;

public class CityList_Activity extends Activity implements OnScrollListener {
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 4) {
					...
					intent(allCity_lists.get(position).getName());
				}
				finish();
			}
		});
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Toast.makeText(getApplicationContext(),
						...
						.show();
				intent(city_result.get(position).getName());
				finish();
			}
		});
		initOverlay();
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Toast.makeText(getApplicationContext(),
								...
								Toast.LENGTH_SHORT).show();
						intent(city_hot.get(position).getName());
						finish();
